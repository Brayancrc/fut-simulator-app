package me.dio.gamessimulationsbrayan.ui.adapter;
...
import me.dio.gamessimulationsbrayan.databinding.MatchItemBinding;
import me.dio.gamessimulationsbrayan.domain.Match;
import me.dio.gamessimulationsbrayan.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (match.getAwayTeam().getScore() != null) {
            holder.binding.tvAwayTeamScore.setText(match.getAwayTeam().getScore());
        }
